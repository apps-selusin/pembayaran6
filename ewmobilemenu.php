...
$RootMenu->AddMenuItem(1, "mmi_t01_tahunajaran", $Language->MenuPhrase("1", "MenuText"), "t01_tahunajaranlist.php", 12, "", AllowListMenu('{699E0CB8-ECC6-4DDA-93F3-012C887E6B12}t01_tahunajaran'), FALSE, FALSE);
$RootMenu->AddMenuItem(14, "mmi_t02_sekolah", $Language->MenuPhrase("14", "MenuText"), "t02_sekolahlist.php", 12, "", AllowListMenu('{699E0CB8-ECC6-4DDA-93F3-012C887E6B12}t02_sekolah'), FALSE, FALSE);
$RootMenu->AddMenuItem(15, "mmi_t03_kelas", $Language->MenuPhrase("15", "MenuText"), "t03_kelaslist.php", 12, "", AllowListMenu('{699E0CB8-ECC6-4DDA-93F3-012C887E6B12}t03_kelas'), FALSE, FALSE);
...
$RootMenu->AddMenuItem(25, "mmi_t05_daftarsiswamaster", $Language->MenuPhrase("25", "MenuText"), "t05_daftarsiswamasterlist.php", 12, "", AllowListMenu('{699E0CB8-ECC6-4DDA-93F3-012C887E6B12}t05_daftarsiswamaster'), FALSE, FALSE);
