...
$t06_daftarsiswadetail_grid = NULL; // Initialize page object first

class ct06_daftarsiswadetail_grid extends ct06_daftarsiswadetail {
	...
	// Page object name
	var $PageObjName = 't06_daftarsiswadetail_grid';

	// Grid form hidden field names
	var $FormName = 'ft06_daftarsiswadetailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t06_daftarsiswadetail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t05_daftarsiswamaster") {
			...
			if ($GLOBALS["t05_daftarsiswamaster"]->EventCancelled) $this->EventCancelled = TRUE;
		}
