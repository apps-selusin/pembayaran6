...
class ct01_tahunajaran_list extends ct01_tahunajaran {
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.ft01_tahunajaranlist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_t01_tahunajaran\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_t01_tahunajaran',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.ft01_tahunajaranlist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
ft01_tahunajaranlist.Lists["x_AwalBulan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft01_tahunajaranlist.Lists["x_AwalBulan"].Options = <?php echo json_encode($t01_tahunajaran->AwalBulan->Options()) ?>;
ft01_tahunajaranlist.Lists["x_AkhirBulan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft01_tahunajaranlist.Lists["x_AkhirBulan"].Options = <?php echo json_encode($t01_tahunajaran->AkhirBulan->Options()) ?>;
...
<?php
	...
	if ($t01_tahunajaran->CurrentAction == "" && $t01_tahunajaran_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$t01_tahunajaran_list->setWarningMessage(ew_DeniedMsg());
...
<?php if ($t01_tahunajaran->AwalBulan->Visible) { // AwalBulan ?>
	<?php if ($t01_tahunajaran->SortUrl($t01_tahunajaran->AwalBulan) == "") { ?>
		<th data-name="AwalBulan"><div id="elh_t01_tahunajaran_AwalBulan" class="t01_tahunajaran_AwalBulan"><div class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->AwalBulan->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="AwalBulan"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_tahunajaran->SortUrl($t01_tahunajaran->AwalBulan) ?>',2);"><div id="elh_t01_tahunajaran_AwalBulan" class="t01_tahunajaran_AwalBulan">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->AwalBulan->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t01_tahunajaran->AwalBulan->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t01_tahunajaran->AwalBulan->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($t01_tahunajaran->AwalTahun->Visible) { // AwalTahun ?>
	<?php if ($t01_tahunajaran->SortUrl($t01_tahunajaran->AwalTahun) == "") { ?>
		<th data-name="AwalTahun"><div id="elh_t01_tahunajaran_AwalTahun" class="t01_tahunajaran_AwalTahun"><div class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->AwalTahun->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="AwalTahun"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_tahunajaran->SortUrl($t01_tahunajaran->AwalTahun) ?>',2);"><div id="elh_t01_tahunajaran_AwalTahun" class="t01_tahunajaran_AwalTahun">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->AwalTahun->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t01_tahunajaran->AwalTahun->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t01_tahunajaran->AwalTahun->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($t01_tahunajaran->AkhirBulan->Visible) { // AkhirBulan ?>
	<?php if ($t01_tahunajaran->SortUrl($t01_tahunajaran->AkhirBulan) == "") { ?>
		<th data-name="AkhirBulan"><div id="elh_t01_tahunajaran_AkhirBulan" class="t01_tahunajaran_AkhirBulan"><div class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->AkhirBulan->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="AkhirBulan"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_tahunajaran->SortUrl($t01_tahunajaran->AkhirBulan) ?>',2);"><div id="elh_t01_tahunajaran_AkhirBulan" class="t01_tahunajaran_AkhirBulan">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->AkhirBulan->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t01_tahunajaran->AkhirBulan->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t01_tahunajaran->AkhirBulan->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($t01_tahunajaran->AkhirTahun->Visible) { // AkhirTahun ?>
	<?php if ($t01_tahunajaran->SortUrl($t01_tahunajaran->AkhirTahun) == "") { ?>
		<th data-name="AkhirTahun"><div id="elh_t01_tahunajaran_AkhirTahun" class="t01_tahunajaran_AkhirTahun"><div class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->AkhirTahun->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="AkhirTahun"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_tahunajaran->SortUrl($t01_tahunajaran->AkhirTahun) ?>',2);"><div id="elh_t01_tahunajaran_AkhirTahun" class="t01_tahunajaran_AkhirTahun">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->AkhirTahun->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t01_tahunajaran->AkhirTahun->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t01_tahunajaran->AkhirTahun->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($t01_tahunajaran->TahunAjaran->Visible) { // TahunAjaran ?>
	<?php if ($t01_tahunajaran->SortUrl($t01_tahunajaran->TahunAjaran) == "") { ?>
		<th data-name="TahunAjaran"><div id="elh_t01_tahunajaran_TahunAjaran" class="t01_tahunajaran_TahunAjaran"><div class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->TahunAjaran->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="TahunAjaran"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_tahunajaran->SortUrl($t01_tahunajaran->TahunAjaran) ?>',2);"><div id="elh_t01_tahunajaran_TahunAjaran" class="t01_tahunajaran_TahunAjaran">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t01_tahunajaran->TahunAjaran->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t01_tahunajaran->TahunAjaran->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t01_tahunajaran->TahunAjaran->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
?>
	<?php if ($t01_tahunajaran->AwalBulan->Visible) { // AwalBulan ?>
		<td data-name="AwalBulan"<?php echo $t01_tahunajaran->AwalBulan->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_list->RowCnt ?>_t01_tahunajaran_AwalBulan" class="t01_tahunajaran_AwalBulan">
<span<?php echo $t01_tahunajaran->AwalBulan->ViewAttributes() ?>>
<?php echo $t01_tahunajaran->AwalBulan->ListViewValue() ?></span>
</span>
<a id="<?php echo $t01_tahunajaran_list->PageObjName . "_row_" . $t01_tahunajaran_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($t01_tahunajaran->AwalTahun->Visible) { // AwalTahun ?>
		<td data-name="AwalTahun"<?php echo $t01_tahunajaran->AwalTahun->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_list->RowCnt ?>_t01_tahunajaran_AwalTahun" class="t01_tahunajaran_AwalTahun">
<span<?php echo $t01_tahunajaran->AwalTahun->ViewAttributes() ?>>
<?php echo $t01_tahunajaran->AwalTahun->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t01_tahunajaran->AkhirBulan->Visible) { // AkhirBulan ?>
		<td data-name="AkhirBulan"<?php echo $t01_tahunajaran->AkhirBulan->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_list->RowCnt ?>_t01_tahunajaran_AkhirBulan" class="t01_tahunajaran_AkhirBulan">
<span<?php echo $t01_tahunajaran->AkhirBulan->ViewAttributes() ?>>
<?php echo $t01_tahunajaran->AkhirBulan->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t01_tahunajaran->AkhirTahun->Visible) { // AkhirTahun ?>
		<td data-name="AkhirTahun"<?php echo $t01_tahunajaran->AkhirTahun->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_list->RowCnt ?>_t01_tahunajaran_AkhirTahun" class="t01_tahunajaran_AkhirTahun">
<span<?php echo $t01_tahunajaran->AkhirTahun->ViewAttributes() ?>>
<?php echo $t01_tahunajaran->AkhirTahun->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t01_tahunajaran->TahunAjaran->Visible) { // TahunAjaran ?>
		<td data-name="TahunAjaran"<?php echo $t01_tahunajaran->TahunAjaran->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_list->RowCnt ?>_t01_tahunajaran_TahunAjaran" class="t01_tahunajaran_TahunAjaran">
<span<?php echo $t01_tahunajaran->TahunAjaran->ViewAttributes() ?>>
<?php echo $t01_tahunajaran->TahunAjaran->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t01_tahunajaran->Aktif->Visible) { // Aktif ?>
...
<?php } ?>
<?php if ($t01_tahunajaran_list->TotalRecs > 0 && (!EW_AUTO_HIDE_PAGE_SIZE_SELECTOR || $t01_tahunajaran_list->Pager->Visible)) { ?>
<div class="ewPager">
<input type="hidden" name="t" value="t01_tahunajaran">
<select name="<?php echo EW_TABLE_REC_PER_PAGE ?>" class="form-control input-sm ewTooltip" title="<?php echo $Language->Phrase("RecordsPerPage") ?>" onchange="this.form.submit();">
<option value="10"<?php if ($t01_tahunajaran_list->DisplayRecs == 10) { ?> selected<?php } ?>>10</option>
<option value="20"<?php if ($t01_tahunajaran_list->DisplayRecs == 20) { ?> selected<?php } ?>>20</option>
<option value="50"<?php if ($t01_tahunajaran_list->DisplayRecs == 50) { ?> selected<?php } ?>>50</option>
<option value="100"<?php if ($t01_tahunajaran_list->DisplayRecs == 100) { ?> selected<?php } ?>>100</option>
<option value="ALL"<?php if ($t01_tahunajaran->getRecordsPerPage() == -1) { ?> selected<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
