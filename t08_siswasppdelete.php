...
$t08_siswaspp_delete = NULL; // Initialize page object first

class ct08_siswaspp_delete extends ct08_siswaspp {
	...
	// Page object name
	var $PageObjName = 't08_siswaspp_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t08_siswaspplist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t08_siswaspp class, t08_siswasppinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t08_siswaspplist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t08_siswaspp_delete)) $t08_siswaspp_delete = new ct08_siswaspp_delete();

// Page init
$t08_siswaspp_delete->Page_Init();

// Page main
$t08_siswaspp_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t08_siswaspp_delete->Page_Render();
?>
...
var CurrentForm = ft08_siswasppdelete = new ew_Form("ft08_siswasppdelete", "delete");

// Form_CustomValidate event
ft08_siswasppdelete.Form_CustomValidate = 
...
ft08_siswasppdelete.ValidateRequired = true;
<?php } else { ?>
ft08_siswasppdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft08_siswasppdelete.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_tahunajaran"};
ft08_siswasppdelete.Lists["x_spp_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_SPP","x_Jenis","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t07_spp"};
...
<?php $t08_siswaspp_delete->ShowPageHeader(); ?>
<?php
$t08_siswaspp_delete->ShowMessage();
?>
<form name="ft08_siswasppdelete" id="ft08_siswasppdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t08_siswaspp_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t08_siswaspp_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t08_siswaspp">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t08_siswaspp_delete->RecKeys as $key) { ?>
...
<?php if ($t08_siswaspp->tahunajaran_id->Visible) { // tahunajaran_id ?>
		<th><span id="elh_t08_siswaspp_tahunajaran_id" class="t08_siswaspp_tahunajaran_id"><?php echo $t08_siswaspp->tahunajaran_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t08_siswaspp->spp_id->Visible) { // spp_id ?>
		<th><span id="elh_t08_siswaspp_spp_id" class="t08_siswaspp_spp_id"><?php echo $t08_siswaspp->spp_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t08_siswaspp->Nilai->Visible) { // Nilai ?>
		<th><span id="elh_t08_siswaspp_Nilai" class="t08_siswaspp_Nilai"><?php echo $t08_siswaspp->Nilai->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t08_siswaspp->Terbayar->Visible) { // Terbayar ?>
		<th><span id="elh_t08_siswaspp_Terbayar" class="t08_siswaspp_Terbayar"><?php echo $t08_siswaspp->Terbayar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t08_siswaspp->Potensi->Visible) { // Potensi ?>
		<th><span id="elh_t08_siswaspp_Potensi" class="t08_siswaspp_Potensi"><?php echo $t08_siswaspp->Potensi->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t08_siswaspp_delete->RecCnt = 0;
$i = 0;
while (!$t08_siswaspp_delete->Recordset->EOF) {
	$t08_siswaspp_delete->RecCnt++;
	$t08_siswaspp_delete->RowCnt++;

	// Set row properties
	$t08_siswaspp->ResetAttrs();
	$t08_siswaspp->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t08_siswaspp_delete->LoadRowValues($t08_siswaspp_delete->Recordset);

	// Render row
	$t08_siswaspp_delete->RenderRow();
?>
	<tr<?php echo $t08_siswaspp->RowAttributes() ?>>
<?php if ($t08_siswaspp->tahunajaran_id->Visible) { // tahunajaran_id ?>
		<td<?php echo $t08_siswaspp->tahunajaran_id->CellAttributes() ?>>
<span id="el<?php echo $t08_siswaspp_delete->RowCnt ?>_t08_siswaspp_tahunajaran_id" class="t08_siswaspp_tahunajaran_id">
...
<?php } ?>
<?php if ($t08_siswaspp->spp_id->Visible) { // spp_id ?>
		<td<?php echo $t08_siswaspp->spp_id->CellAttributes() ?>>
<span id="el<?php echo $t08_siswaspp_delete->RowCnt ?>_t08_siswaspp_spp_id" class="t08_siswaspp_spp_id">
...
<?php } ?>
<?php if ($t08_siswaspp->Nilai->Visible) { // Nilai ?>
		<td<?php echo $t08_siswaspp->Nilai->CellAttributes() ?>>
<span id="el<?php echo $t08_siswaspp_delete->RowCnt ?>_t08_siswaspp_Nilai" class="t08_siswaspp_Nilai">
...
<?php } ?>
<?php if ($t08_siswaspp->Terbayar->Visible) { // Terbayar ?>
		<td<?php echo $t08_siswaspp->Terbayar->CellAttributes() ?>>
<span id="el<?php echo $t08_siswaspp_delete->RowCnt ?>_t08_siswaspp_Terbayar" class="t08_siswaspp_Terbayar">
...
<?php } ?>
<?php if ($t08_siswaspp->Potensi->Visible) { // Potensi ?>
		<td<?php echo $t08_siswaspp->Potensi->CellAttributes() ?>>
<span id="el<?php echo $t08_siswaspp_delete->RowCnt ?>_t08_siswaspp_Potensi" class="t08_siswaspp_Potensi">
...
<?php
	$t08_siswaspp_delete->Recordset->MoveNext();
}
$t08_siswaspp_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t08_siswaspp_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft08_siswasppdelete.Init();
</script>
<?php
$t08_siswaspp_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t08_siswaspp_delete->Page_Terminate();
?>
