...
$t10_bayardetail_grid = NULL; // Initialize page object first

class ct10_bayardetail_grid extends ct10_bayardetail {
	...
	// Page object name
	var $PageObjName = 't10_bayardetail_grid';

	// Grid form hidden field names
	var $FormName = 'ft10_bayardetailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t10_bayardetail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t09_bayarmaster") {
			...
			if ($GLOBALS["t09_bayarmaster"]->EventCancelled) $this->EventCancelled = TRUE;
		}
