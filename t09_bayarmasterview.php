...
$t09_bayarmaster_view = NULL; // Initialize page object first

class ct09_bayarmaster_view extends ct09_bayarmaster {
	...
	// Page object name
	var $PageObjName = 't09_bayarmaster_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("t09_bayarmasterlist.php"); // Return to list page
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t09_bayarmasterlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t09_bayarmasterlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		$item = &$option->Add("detail_t10_bayardetail");
		$body = $Language->Phrase("ViewPageDetailLink") . $Language->TablePhrase("t10_bayardetail", "TblCaption");
		...
		$links = "";
		if ($GLOBALS["t10_bayardetail_grid"] && $GLOBALS["t10_bayardetail_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 't10_bayardetail')) {
		...
		if ($GLOBALS["t10_bayardetail_grid"] && $GLOBALS["t10_bayardetail_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 't10_bayardetail')) {
		...
		if ($GLOBALS["t10_bayardetail_grid"] && $GLOBALS["t10_bayardetail_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 't10_bayardetail')) {
		...
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 't10_bayardetail');
		if ($item->Visible) {
	...
	function ExportData() {
		...
		// Export detail records (t10_bayardetail)
		if (EW_EXPORT_DETAIL_RECORDS && in_array("t10_bayardetail", explode(",", $this->getCurrentDetailTable()))) {
			global $t10_bayardetail;
			if (!isset($t10_bayardetail)) $t10_bayardetail = new ct10_bayardetail;
			$rsdetail = $t10_bayardetail->LoadRs($t10_bayardetail->GetDetailFilter()); // Load detail records
			if ($rsdetail && !$rsdetail->EOF) {
				...
				if ($this->Export <> "csv" || EW_EXPORT_DETAIL_RECORDS_FOR_CSV) {
					...
					$t10_bayardetail->ExportDocument($Doc, $rsdetail, 1, $detailcnt);
				}
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("t10_bayardetail", $DetailTblVar)) {
				...
				if ($GLOBALS["t10_bayardetail_grid"]->DetailView) {
					$GLOBALS["t10_bayardetail_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($t09_bayarmaster_view)) $t09_bayarmaster_view = new ct09_bayarmaster_view();

// Page init
$t09_bayarmaster_view->Page_Init();

// Page main
$t09_bayarmaster_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t09_bayarmaster_view->Page_Render();
?>
...
var CurrentForm = ft09_bayarmasterview = new ew_Form("ft09_bayarmasterview", "view");

// Form_CustomValidate event
ft09_bayarmasterview.Form_CustomValidate = 
...
ft09_bayarmasterview.ValidateRequired = true;
<?php } else { ?>
ft09_bayarmasterview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft09_bayarmasterview.Lists["x_siswa_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_NIS","x_Nama","",""],"ParentFields":[],"ChildFields":["t10_bayardetail x_siswaspp_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t04_siswa"};
ft09_bayarmasterview.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_tahunajaran"};
...
<?php if ($t09_bayarmaster->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t09_bayarmaster_view->IsModal) { ?>
<?php if ($t09_bayarmaster->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t09_bayarmaster_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t09_bayarmaster_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t09_bayarmaster_view->IsModal) { ?>
<?php if ($t09_bayarmaster->Export == "") { ?>
...
<?php } ?>
<?php $t09_bayarmaster_view->ShowPageHeader(); ?>
<?php
$t09_bayarmaster_view->ShowMessage();
?>
<form name="ft09_bayarmasterview" id="ft09_bayarmasterview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t09_bayarmaster_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t09_bayarmaster_view->Token ?>">
<?php } ?>
...
<?php if ($t09_bayarmaster->siswa_id->Visible) { // siswa_id ?>
	<tr id="r_siswa_id">
		<td><span id="elh_t09_bayarmaster_siswa_id"><?php echo $t09_bayarmaster->siswa_id->FldCaption() ?></span></td>
...
<?php echo $t09_bayarmaster->siswa_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t09_bayarmaster->tahunajaran_id->Visible) { // tahunajaran_id ?>
	<tr id="r_tahunajaran_id">
		<td><span id="elh_t09_bayarmaster_tahunajaran_id"><?php echo $t09_bayarmaster->tahunajaran_id->FldCaption() ?></span></td>
...
<?php echo $t09_bayarmaster->tahunajaran_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t09_bayarmaster->Tanggal->Visible) { // Tanggal ?>
	<tr id="r_Tanggal">
		<td><span id="elh_t09_bayarmaster_Tanggal"><?php echo $t09_bayarmaster->Tanggal->FldCaption() ?></span></td>
...
<?php echo $t09_bayarmaster->Tanggal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t09_bayarmaster->NomorBayar->Visible) { // NomorBayar ?>
	<tr id="r_NomorBayar">
		<td><span id="elh_t09_bayarmaster_NomorBayar"><?php echo $t09_bayarmaster->NomorBayar->FldCaption() ?></span></td>
...
<?php echo $t09_bayarmaster->NomorBayar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t09_bayarmaster->Jumlah->Visible) { // Jumlah ?>
	<tr id="r_Jumlah">
		<td><span id="elh_t09_bayarmaster_Jumlah"><?php echo $t09_bayarmaster->Jumlah->FldCaption() ?></span></td>
...
<?php echo $t09_bayarmaster->Jumlah->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if (!$t09_bayarmaster_view->IsModal) { ?>
<?php if ($t09_bayarmaster->Export == "") { ?>
<?php if (!isset($t09_bayarmaster_view->Pager)) $t09_bayarmaster_view->Pager = new cPrevNextPager($t09_bayarmaster_view->StartRec, $t09_bayarmaster_view->DisplayRecs, $t09_bayarmaster_view->TotalRecs) ?>
<?php if ($t09_bayarmaster_view->Pager->RecordCount > 0 && $t09_bayarmaster_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t09_bayarmaster_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t09_bayarmaster_view->PageUrl() ?>start=<?php echo $t09_bayarmaster_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t09_bayarmaster_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t09_bayarmaster_view->PageUrl() ?>start=<?php echo $t09_bayarmaster_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t09_bayarmaster_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t09_bayarmaster_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t09_bayarmaster_view->PageUrl() ?>start=<?php echo $t09_bayarmaster_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t09_bayarmaster_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t09_bayarmaster_view->PageUrl() ?>start=<?php echo $t09_bayarmaster_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t09_bayarmaster_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
<?php } ?>
<?php
	if (in_array("t10_bayardetail", explode(",", $t09_bayarmaster->getCurrentDetailTable())) && $t10_bayardetail->DetailView) {
?>
...
<?php if ($t09_bayarmaster->Export == "") { ?>
<script type="text/javascript">
ft09_bayarmasterview.Init();
</script>
<?php } ?>
<?php
$t09_bayarmaster_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t09_bayarmaster->Export == "") { ?>
...
<?php
$t09_bayarmaster_view->Page_Terminate();
?>
