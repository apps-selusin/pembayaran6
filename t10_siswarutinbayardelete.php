...
$t10_siswarutinbayar_delete = NULL; // Initialize page object first

class ct10_siswarutinbayar_delete extends ct10_siswarutinbayar {
	...
	// Page object name
	var $PageObjName = 't10_siswarutinbayar_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t10_siswarutinbayarlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t10_siswarutinbayar class, t10_siswarutinbayarinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t10_siswarutinbayarlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t10_siswarutinbayar_delete)) $t10_siswarutinbayar_delete = new ct10_siswarutinbayar_delete();

// Page init
$t10_siswarutinbayar_delete->Page_Init();

// Page main
$t10_siswarutinbayar_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t10_siswarutinbayar_delete->Page_Render();
?>
...
var CurrentForm = ft10_siswarutinbayardelete = new ew_Form("ft10_siswarutinbayardelete", "delete");

// Form_CustomValidate event
ft10_siswarutinbayardelete.Form_CustomValidate = 
...
ft10_siswarutinbayardelete.ValidateRequired = true;
<?php } else { ?>
ft10_siswarutinbayardelete.ValidateRequired = false; 
<?php } ?>
...
<?php $t10_siswarutinbayar_delete->ShowPageHeader(); ?>
<?php
$t10_siswarutinbayar_delete->ShowMessage();
?>
<form name="ft10_siswarutinbayardelete" id="ft10_siswarutinbayardelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t10_siswarutinbayar_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t10_siswarutinbayar_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t10_siswarutinbayar">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t10_siswarutinbayar_delete->RecKeys as $key) { ?>
...
<?php if ($t10_siswarutinbayar->Periode->Visible) { // Periode ?>
		<th><span id="elh_t10_siswarutinbayar_Periode" class="t10_siswarutinbayar_Periode"><?php echo $t10_siswarutinbayar->Periode->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t10_siswarutinbayar->TanggalBayar->Visible) { // TanggalBayar ?>
		<th><span id="elh_t10_siswarutinbayar_TanggalBayar" class="t10_siswarutinbayar_TanggalBayar"><?php echo $t10_siswarutinbayar->TanggalBayar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t10_siswarutinbayar->JumlahBayar->Visible) { // JumlahBayar ?>
		<th><span id="elh_t10_siswarutinbayar_JumlahBayar" class="t10_siswarutinbayar_JumlahBayar"><?php echo $t10_siswarutinbayar->JumlahBayar->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t10_siswarutinbayar_delete->RecCnt = 0;
$i = 0;
while (!$t10_siswarutinbayar_delete->Recordset->EOF) {
	$t10_siswarutinbayar_delete->RecCnt++;
	$t10_siswarutinbayar_delete->RowCnt++;

	// Set row properties
	$t10_siswarutinbayar->ResetAttrs();
	$t10_siswarutinbayar->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t10_siswarutinbayar_delete->LoadRowValues($t10_siswarutinbayar_delete->Recordset);

	// Render row
	$t10_siswarutinbayar_delete->RenderRow();
?>
	<tr<?php echo $t10_siswarutinbayar->RowAttributes() ?>>
<?php if ($t10_siswarutinbayar->Periode->Visible) { // Periode ?>
		<td<?php echo $t10_siswarutinbayar->Periode->CellAttributes() ?>>
<span id="el<?php echo $t10_siswarutinbayar_delete->RowCnt ?>_t10_siswarutinbayar_Periode" class="t10_siswarutinbayar_Periode">
...
<?php } ?>
<?php if ($t10_siswarutinbayar->TanggalBayar->Visible) { // TanggalBayar ?>
		<td<?php echo $t10_siswarutinbayar->TanggalBayar->CellAttributes() ?>>
<span id="el<?php echo $t10_siswarutinbayar_delete->RowCnt ?>_t10_siswarutinbayar_TanggalBayar" class="t10_siswarutinbayar_TanggalBayar">
...
<?php } ?>
<?php if ($t10_siswarutinbayar->JumlahBayar->Visible) { // JumlahBayar ?>
		<td<?php echo $t10_siswarutinbayar->JumlahBayar->CellAttributes() ?>>
<span id="el<?php echo $t10_siswarutinbayar_delete->RowCnt ?>_t10_siswarutinbayar_JumlahBayar" class="t10_siswarutinbayar_JumlahBayar">
...
<?php
	$t10_siswarutinbayar_delete->Recordset->MoveNext();
}
$t10_siswarutinbayar_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t10_siswarutinbayar_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft10_siswarutinbayardelete.Init();
</script>
<?php
$t10_siswarutinbayar_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t10_siswarutinbayar_delete->Page_Terminate();
?>
