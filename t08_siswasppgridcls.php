...
$t08_siswaspp_grid = NULL; // Initialize page object first

class ct08_siswaspp_grid extends ct08_siswaspp {
	...
	// Page object name
	var $PageObjName = 't08_siswaspp_grid';

	// Grid form hidden field names
	var $FormName = 'ft08_siswasppgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t08_siswaspp"];
