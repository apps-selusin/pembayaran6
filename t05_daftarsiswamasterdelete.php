...
$t05_daftarsiswamaster_delete = NULL; // Initialize page object first

class ct05_daftarsiswamaster_delete extends ct05_daftarsiswamaster {
	...
	// Page object name
	var $PageObjName = 't05_daftarsiswamaster_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t05_daftarsiswamasterlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t05_daftarsiswamaster class, t05_daftarsiswamasterinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t05_daftarsiswamasterlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t05_daftarsiswamaster_delete)) $t05_daftarsiswamaster_delete = new ct05_daftarsiswamaster_delete();

// Page init
$t05_daftarsiswamaster_delete->Page_Init();

// Page main
$t05_daftarsiswamaster_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t05_daftarsiswamaster_delete->Page_Render();
?>
...
var CurrentForm = ft05_daftarsiswamasterdelete = new ew_Form("ft05_daftarsiswamasterdelete", "delete");

// Form_CustomValidate event
ft05_daftarsiswamasterdelete.Form_CustomValidate = 
...
ft05_daftarsiswamasterdelete.ValidateRequired = true;
<?php } else { ?>
ft05_daftarsiswamasterdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft05_daftarsiswamasterdelete.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_tahunajaran"};
ft05_daftarsiswamasterdelete.Lists["x_sekolah_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Sekolah","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t02_sekolah"};
ft05_daftarsiswamasterdelete.Lists["x_kelas_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Kelas","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t03_kelas"};
...
<?php $t05_daftarsiswamaster_delete->ShowPageHeader(); ?>
<?php
$t05_daftarsiswamaster_delete->ShowMessage();
?>
<form name="ft05_daftarsiswamasterdelete" id="ft05_daftarsiswamasterdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t05_daftarsiswamaster_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t05_daftarsiswamaster_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t05_daftarsiswamaster">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t05_daftarsiswamaster_delete->RecKeys as $key) { ?>
...
<?php if ($t05_daftarsiswamaster->tahunajaran_id->Visible) { // tahunajaran_id ?>
		<th><span id="elh_t05_daftarsiswamaster_tahunajaran_id" class="t05_daftarsiswamaster_tahunajaran_id"><?php echo $t05_daftarsiswamaster->tahunajaran_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t05_daftarsiswamaster->sekolah_id->Visible) { // sekolah_id ?>
		<th><span id="elh_t05_daftarsiswamaster_sekolah_id" class="t05_daftarsiswamaster_sekolah_id"><?php echo $t05_daftarsiswamaster->sekolah_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t05_daftarsiswamaster->kelas_id->Visible) { // kelas_id ?>
		<th><span id="elh_t05_daftarsiswamaster_kelas_id" class="t05_daftarsiswamaster_kelas_id"><?php echo $t05_daftarsiswamaster->kelas_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t05_daftarsiswamaster_delete->RecCnt = 0;
$i = 0;
while (!$t05_daftarsiswamaster_delete->Recordset->EOF) {
	$t05_daftarsiswamaster_delete->RecCnt++;
	$t05_daftarsiswamaster_delete->RowCnt++;

	// Set row properties
	$t05_daftarsiswamaster->ResetAttrs();
	$t05_daftarsiswamaster->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t05_daftarsiswamaster_delete->LoadRowValues($t05_daftarsiswamaster_delete->Recordset);

	// Render row
	$t05_daftarsiswamaster_delete->RenderRow();
?>
	<tr<?php echo $t05_daftarsiswamaster->RowAttributes() ?>>
<?php if ($t05_daftarsiswamaster->tahunajaran_id->Visible) { // tahunajaran_id ?>
		<td<?php echo $t05_daftarsiswamaster->tahunajaran_id->CellAttributes() ?>>
<span id="el<?php echo $t05_daftarsiswamaster_delete->RowCnt ?>_t05_daftarsiswamaster_tahunajaran_id" class="t05_daftarsiswamaster_tahunajaran_id">
...
<span id="el<?php echo $t05_daftarsiswamaster_delete->RowCnt ?>_t05_daftarsiswamaster_sekolah_id" class="t05_daftarsiswamaster_sekolah_id">
...
<span id="el<?php echo $t05_daftarsiswamaster_delete->RowCnt ?>_t05_daftarsiswamaster_kelas_id" class="t05_daftarsiswamaster_kelas_id">
...
<?php
	$t05_daftarsiswamaster_delete->Recordset->MoveNext();
}
$t05_daftarsiswamaster_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t05_daftarsiswamaster_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft05_daftarsiswamasterdelete.Init();
</script>
<?php
$t05_daftarsiswamaster_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t05_daftarsiswamaster_delete->Page_Terminate();
?>
