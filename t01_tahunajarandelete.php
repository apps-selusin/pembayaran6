...
ft01_tahunajarandelete.Lists["x_AwalBulan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft01_tahunajarandelete.Lists["x_AwalBulan"].Options = <?php echo json_encode($t01_tahunajaran->AwalBulan->Options()) ?>;
ft01_tahunajarandelete.Lists["x_AkhirBulan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft01_tahunajarandelete.Lists["x_AkhirBulan"].Options = <?php echo json_encode($t01_tahunajaran->AkhirBulan->Options()) ?>;
...
<?php if ($t01_tahunajaran->AwalBulan->Visible) { // AwalBulan ?>
		<th><span id="elh_t01_tahunajaran_AwalBulan" class="t01_tahunajaran_AwalBulan"><?php echo $t01_tahunajaran->AwalBulan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t01_tahunajaran->AwalTahun->Visible) { // AwalTahun ?>
		<th><span id="elh_t01_tahunajaran_AwalTahun" class="t01_tahunajaran_AwalTahun"><?php echo $t01_tahunajaran->AwalTahun->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t01_tahunajaran->AkhirBulan->Visible) { // AkhirBulan ?>
		<th><span id="elh_t01_tahunajaran_AkhirBulan" class="t01_tahunajaran_AkhirBulan"><?php echo $t01_tahunajaran->AkhirBulan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t01_tahunajaran->AkhirTahun->Visible) { // AkhirTahun ?>
		<th><span id="elh_t01_tahunajaran_AkhirTahun" class="t01_tahunajaran_AkhirTahun"><?php echo $t01_tahunajaran->AkhirTahun->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t01_tahunajaran->TahunAjaran->Visible) { // TahunAjaran ?>
		<th><span id="elh_t01_tahunajaran_TahunAjaran" class="t01_tahunajaran_TahunAjaran"><?php echo $t01_tahunajaran->TahunAjaran->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($t01_tahunajaran->AwalBulan->Visible) { // AwalBulan ?>
		<td<?php echo $t01_tahunajaran->AwalBulan->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_delete->RowCnt ?>_t01_tahunajaran_AwalBulan" class="t01_tahunajaran_AwalBulan">
...
<?php } ?>
<?php if ($t01_tahunajaran->AwalTahun->Visible) { // AwalTahun ?>
		<td<?php echo $t01_tahunajaran->AwalTahun->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_delete->RowCnt ?>_t01_tahunajaran_AwalTahun" class="t01_tahunajaran_AwalTahun">
...
<?php } ?>
<?php if ($t01_tahunajaran->AkhirBulan->Visible) { // AkhirBulan ?>
		<td<?php echo $t01_tahunajaran->AkhirBulan->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_delete->RowCnt ?>_t01_tahunajaran_AkhirBulan" class="t01_tahunajaran_AkhirBulan">
...
<?php } ?>
<?php if ($t01_tahunajaran->AkhirTahun->Visible) { // AkhirTahun ?>
		<td<?php echo $t01_tahunajaran->AkhirTahun->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_delete->RowCnt ?>_t01_tahunajaran_AkhirTahun" class="t01_tahunajaran_AkhirTahun">
...
<?php } ?>
<?php if ($t01_tahunajaran->TahunAjaran->Visible) { // TahunAjaran ?>
		<td<?php echo $t01_tahunajaran->TahunAjaran->CellAttributes() ?>>
<span id="el<?php echo $t01_tahunajaran_delete->RowCnt ?>_t01_tahunajaran_TahunAjaran" class="t01_tahunajaran_TahunAjaran">
