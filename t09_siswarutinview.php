...
$t09_siswarutin_view = NULL; // Initialize page object first

class ct09_siswarutin_view extends ct09_siswarutin {
	...
	// Page object name
	var $PageObjName = 't09_siswarutin_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t09_siswarutinlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t09_siswarutinlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t09_siswarutin_view)) $t09_siswarutin_view = new ct09_siswarutin_view();

// Page init
$t09_siswarutin_view->Page_Init();

// Page main
$t09_siswarutin_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t09_siswarutin_view->Page_Render();
?>
...
var CurrentForm = ft09_siswarutinview = new ew_Form("ft09_siswarutinview", "view");

// Form_CustomValidate event
ft09_siswarutinview.Form_CustomValidate = 
...
ft09_siswarutinview.ValidateRequired = true;
<?php } else { ?>
ft09_siswarutinview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft09_siswarutinview.Lists["x_rutin_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Jenis","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t07_rutin"};
ft09_siswarutinview.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_tahunajaran"};
...
<?php if ($t09_siswarutin->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t09_siswarutin_view->IsModal) { ?>
<?php if ($t09_siswarutin->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t09_siswarutin_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t09_siswarutin_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t09_siswarutin_view->IsModal) { ?>
<?php if ($t09_siswarutin->Export == "") { ?>
...
<?php } ?>
<?php $t09_siswarutin_view->ShowPageHeader(); ?>
<?php
$t09_siswarutin_view->ShowMessage();
?>
<form name="ft09_siswarutinview" id="ft09_siswarutinview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t09_siswarutin_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t09_siswarutin_view->Token ?>">
<?php } ?>
...
<?php if ($t09_siswarutin->rutin_id->Visible) { // rutin_id ?>
	<tr id="r_rutin_id">
		<td><span id="elh_t09_siswarutin_rutin_id"><?php echo $t09_siswarutin->rutin_id->FldCaption() ?></span></td>
...
<?php echo $t09_siswarutin->rutin_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t09_siswarutin->tahunajaran_id->Visible) { // tahunajaran_id ?>
	<tr id="r_tahunajaran_id">
		<td><span id="elh_t09_siswarutin_tahunajaran_id"><?php echo $t09_siswarutin->tahunajaran_id->FldCaption() ?></span></td>
...
<?php echo $t09_siswarutin->tahunajaran_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t09_siswarutin->nilai->Visible) { // nilai ?>
	<tr id="r_nilai">
		<td><span id="elh_t09_siswarutin_nilai"><?php echo $t09_siswarutin->nilai->FldCaption() ?></span></td>
...
<?php echo $t09_siswarutin->nilai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t09_siswarutin->Total->Visible) { // Total ?>
	<tr id="r_Total">
		<td><span id="elh_t09_siswarutin_Total"><?php echo $t09_siswarutin->Total->FldCaption() ?></span></td>
...
<?php echo $t09_siswarutin->Total->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if (!$t09_siswarutin_view->IsModal) { ?>
<?php if ($t09_siswarutin->Export == "") { ?>
<?php if (!isset($t09_siswarutin_view->Pager)) $t09_siswarutin_view->Pager = new cPrevNextPager($t09_siswarutin_view->StartRec, $t09_siswarutin_view->DisplayRecs, $t09_siswarutin_view->TotalRecs) ?>
<?php if ($t09_siswarutin_view->Pager->RecordCount > 0 && $t09_siswarutin_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t09_siswarutin_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t09_siswarutin_view->PageUrl() ?>start=<?php echo $t09_siswarutin_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t09_siswarutin_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t09_siswarutin_view->PageUrl() ?>start=<?php echo $t09_siswarutin_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t09_siswarutin_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t09_siswarutin_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t09_siswarutin_view->PageUrl() ?>start=<?php echo $t09_siswarutin_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t09_siswarutin_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t09_siswarutin_view->PageUrl() ?>start=<?php echo $t09_siswarutin_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t09_siswarutin_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
...
<?php if ($t09_siswarutin->Export == "") { ?>
<script type="text/javascript">
ft09_siswarutinview.Init();
</script>
<?php } ?>
<?php
$t09_siswarutin_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t09_siswarutin->Export == "") { ?>
...
<?php
$t09_siswarutin_view->Page_Terminate();
?>
