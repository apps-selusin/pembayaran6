...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 't01_tahunajaran'))
			$this->Page_Terminate("t01_tahunajaranlist.php");
		if ($Security->AllowList(CurrentProjectID() . 't02_sekolah'))
			$this->Page_Terminate("t02_sekolahlist.php");
		if ($Security->AllowList(CurrentProjectID() . 't03_kelas'))
			$this->Page_Terminate("t03_kelaslist.php");
		if ($Security->AllowList(CurrentProjectID() . 't04_siswa'))
			$this->Page_Terminate("t04_siswalist.php");
		if ($Security->AllowList(CurrentProjectID() . 't05_daftarsiswamaster'))
		...
		if ($Security->AllowList(CurrentProjectID() . 'v03_kartuspp'))
			$this->Page_Terminate("v03_kartuspplist.php");
