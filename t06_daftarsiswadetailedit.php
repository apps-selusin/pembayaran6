...
$t06_daftarsiswadetail_edit = NULL; // Initialize page object first

class ct06_daftarsiswadetail_edit extends ct06_daftarsiswadetail {
	...
	// Page object name
	var $PageObjName = 't06_daftarsiswadetail_edit';
	...
	function EditRow() {
		...
		if ($this->siswa_id->CurrentValue <> "") { // Check field with unique index
			$sFilterChk = "(`siswa_id` = " . ew_AdjustSql($this->siswa_id->CurrentValue, $this->DBID) . ")";
...
// Create page object
if (!isset($t06_daftarsiswadetail_edit)) $t06_daftarsiswadetail_edit = new ct06_daftarsiswadetail_edit();

// Page init
$t06_daftarsiswadetail_edit->Page_Init();

// Page main
$t06_daftarsiswadetail_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t06_daftarsiswadetail_edit->Page_Render();
?>
...
var CurrentForm = ft06_daftarsiswadetailedit = new ew_Form("ft06_daftarsiswadetailedit", "edit");

// Validate form
ft06_daftarsiswadetailedit.Validate = function() {
...
ft06_daftarsiswadetailedit.Form_CustomValidate = 
...
ft06_daftarsiswadetailedit.ValidateRequired = true;
<?php } else { ?>
ft06_daftarsiswadetailedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft06_daftarsiswadetailedit.Lists["x_siswa_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_NIS","x_Nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t04_siswa"};
...
<?php if (!$t06_daftarsiswadetail_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t06_daftarsiswadetail_edit->ShowPageHeader(); ?>
<?php
$t06_daftarsiswadetail_edit->ShowMessage();
?>
<form name="ft06_daftarsiswadetailedit" id="ft06_daftarsiswadetailedit" class="<?php echo $t06_daftarsiswadetail_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t06_daftarsiswadetail_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t06_daftarsiswadetail_edit->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ft06_daftarsiswadetailedit.CreateAutoSuggest({"id":"x_siswa_id","forceSelect":true});
</script>
...
<input type="hidden" data-table="t06_daftarsiswadetail" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t06_daftarsiswadetail->id->CurrentValue) ?>">
<?php if (!$t06_daftarsiswadetail_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t06_daftarsiswadetail_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t06_daftarsiswadetail_edit->Pager)) $t06_daftarsiswadetail_edit->Pager = new cPrevNextPager($t06_daftarsiswadetail_edit->StartRec, $t06_daftarsiswadetail_edit->DisplayRecs, $t06_daftarsiswadetail_edit->TotalRecs) ?>
<?php if ($t06_daftarsiswadetail_edit->Pager->RecordCount > 0 && $t06_daftarsiswadetail_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t06_daftarsiswadetail_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t06_daftarsiswadetail_edit->PageUrl() ?>start=<?php echo $t06_daftarsiswadetail_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t06_daftarsiswadetail_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t06_daftarsiswadetail_edit->PageUrl() ?>start=<?php echo $t06_daftarsiswadetail_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t06_daftarsiswadetail_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t06_daftarsiswadetail_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t06_daftarsiswadetail_edit->PageUrl() ?>start=<?php echo $t06_daftarsiswadetail_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t06_daftarsiswadetail_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t06_daftarsiswadetail_edit->PageUrl() ?>start=<?php echo $t06_daftarsiswadetail_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t06_daftarsiswadetail_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
...
<script type="text/javascript">
ft06_daftarsiswadetailedit.Init();
</script>
<?php
$t06_daftarsiswadetail_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t06_daftarsiswadetail_edit->Page_Terminate();
?>
