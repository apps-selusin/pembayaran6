...
$t10_siswarutinbayar_grid = NULL; // Initialize page object first

class ct10_siswarutinbayar_grid extends ct10_siswarutinbayar {
	...
	// Page object name
	var $PageObjName = 't10_siswarutinbayar_grid';

	// Grid form hidden field names
	var $FormName = 'ft10_siswarutinbayargrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t10_siswarutinbayar"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "v01_siswarutin") {
			...
			if ($GLOBALS["v01_siswarutin"]->EventCancelled) $this->EventCancelled = TRUE;
		}
