...
$t10_bayardetail_view = NULL; // Initialize page object first

class ct10_bayardetail_view extends ct10_bayardetail {
	...
	// Page object name
	var $PageObjName = 't10_bayardetail_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t10_bayardetaillist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t10_bayardetaillist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t10_bayardetail_view)) $t10_bayardetail_view = new ct10_bayardetail_view();

// Page init
$t10_bayardetail_view->Page_Init();

// Page main
$t10_bayardetail_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t10_bayardetail_view->Page_Render();
?>
...
var CurrentForm = ft10_bayardetailview = new ew_Form("ft10_bayardetailview", "view");

// Form_CustomValidate event
ft10_bayardetailview.Form_CustomValidate = 
...
ft10_bayardetailview.ValidateRequired = true;
<?php } else { ?>
ft10_bayardetailview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft10_bayardetailview.Lists["x_siswaspp_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_SPP","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"v01_siswaspp"};
ft10_bayardetailview.Lists["x_Keterangan2"] = {"LinkField":"x_Periode","Ajax":true,"AutoFill":false,"DisplayFields":["x_Periode","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"v03_kartuspp"};
...
<?php if ($t10_bayardetail->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t10_bayardetail_view->IsModal) { ?>
<?php if ($t10_bayardetail->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t10_bayardetail_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t10_bayardetail_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t10_bayardetail_view->IsModal) { ?>
<?php if ($t10_bayardetail->Export == "") { ?>
...
<?php } ?>
<?php $t10_bayardetail_view->ShowPageHeader(); ?>
<?php
$t10_bayardetail_view->ShowMessage();
?>
<form name="ft10_bayardetailview" id="ft10_bayardetailview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t10_bayardetail_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t10_bayardetail_view->Token ?>">
<?php } ?>
...
<?php if ($t10_bayardetail->siswaspp_id->Visible) { // siswaspp_id ?>
	<tr id="r_siswaspp_id">
		<td><span id="elh_t10_bayardetail_siswaspp_id"><?php echo $t10_bayardetail->siswaspp_id->FldCaption() ?></span></td>
...
<?php echo $t10_bayardetail->siswaspp_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t10_bayardetail->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		<td><span id="elh_t10_bayardetail_Keterangan"><?php echo $t10_bayardetail->Keterangan->FldCaption() ?></span></td>
...
<?php echo $t10_bayardetail->Keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t10_bayardetail->Keterangan2->Visible) { // Keterangan2 ?>
	<tr id="r_Keterangan2">
		<td><span id="elh_t10_bayardetail_Keterangan2"><?php echo $t10_bayardetail->Keterangan2->FldCaption() ?></span></td>
...
<?php echo $t10_bayardetail->Keterangan2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t10_bayardetail->Keterangan3->Visible) { // Keterangan3 ?>
	<tr id="r_Keterangan3">
		<td><span id="elh_t10_bayardetail_Keterangan3"><?php echo $t10_bayardetail->Keterangan3->FldCaption() ?></span></td>
...
<?php echo $t10_bayardetail->Keterangan3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t10_bayardetail->Jumlah->Visible) { // Jumlah ?>
	<tr id="r_Jumlah">
		<td><span id="elh_t10_bayardetail_Jumlah"><?php echo $t10_bayardetail->Jumlah->FldCaption() ?></span></td>
...
<?php echo $t10_bayardetail->Jumlah->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if (!$t10_bayardetail_view->IsModal) { ?>
<?php if ($t10_bayardetail->Export == "") { ?>
<?php if (!isset($t10_bayardetail_view->Pager)) $t10_bayardetail_view->Pager = new cPrevNextPager($t10_bayardetail_view->StartRec, $t10_bayardetail_view->DisplayRecs, $t10_bayardetail_view->TotalRecs) ?>
<?php if ($t10_bayardetail_view->Pager->RecordCount > 0 && $t10_bayardetail_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t10_bayardetail_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t10_bayardetail_view->PageUrl() ?>start=<?php echo $t10_bayardetail_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t10_bayardetail_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t10_bayardetail_view->PageUrl() ?>start=<?php echo $t10_bayardetail_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t10_bayardetail_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t10_bayardetail_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t10_bayardetail_view->PageUrl() ?>start=<?php echo $t10_bayardetail_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t10_bayardetail_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t10_bayardetail_view->PageUrl() ?>start=<?php echo $t10_bayardetail_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t10_bayardetail_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
...
<?php if ($t10_bayardetail->Export == "") { ?>
<script type="text/javascript">
ft10_bayardetailview.Init();
</script>
<?php } ?>
<?php
$t10_bayardetail_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t10_bayardetail->Export == "") { ?>
...
<?php
$t10_bayardetail_view->Page_Terminate();
?>
