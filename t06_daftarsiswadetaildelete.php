...
$t06_daftarsiswadetail_delete = NULL; // Initialize page object first

class ct06_daftarsiswadetail_delete extends ct06_daftarsiswadetail {
	...
	// Page object name
	var $PageObjName = 't06_daftarsiswadetail_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t06_daftarsiswadetaillist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t06_daftarsiswadetail class, t06_daftarsiswadetailinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t06_daftarsiswadetaillist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t06_daftarsiswadetail_delete)) $t06_daftarsiswadetail_delete = new ct06_daftarsiswadetail_delete();

// Page init
$t06_daftarsiswadetail_delete->Page_Init();

// Page main
$t06_daftarsiswadetail_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t06_daftarsiswadetail_delete->Page_Render();
?>
...
var CurrentForm = ft06_daftarsiswadetaildelete = new ew_Form("ft06_daftarsiswadetaildelete", "delete");

// Form_CustomValidate event
ft06_daftarsiswadetaildelete.Form_CustomValidate = 
...
ft06_daftarsiswadetaildelete.ValidateRequired = true;
<?php } else { ?>
ft06_daftarsiswadetaildelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft06_daftarsiswadetaildelete.Lists["x_siswa_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_NIS","x_Nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t04_siswa"};
...
<?php $t06_daftarsiswadetail_delete->ShowPageHeader(); ?>
<?php
$t06_daftarsiswadetail_delete->ShowMessage();
?>
<form name="ft06_daftarsiswadetaildelete" id="ft06_daftarsiswadetaildelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t06_daftarsiswadetail_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t06_daftarsiswadetail_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t06_daftarsiswadetail">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t06_daftarsiswadetail_delete->RecKeys as $key) { ?>
...
<?php if ($t06_daftarsiswadetail->siswa_id->Visible) { // siswa_id ?>
		<th><span id="elh_t06_daftarsiswadetail_siswa_id" class="t06_daftarsiswadetail_siswa_id"><?php echo $t06_daftarsiswadetail->siswa_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t06_daftarsiswadetail_delete->RecCnt = 0;
$i = 0;
while (!$t06_daftarsiswadetail_delete->Recordset->EOF) {
	$t06_daftarsiswadetail_delete->RecCnt++;
	$t06_daftarsiswadetail_delete->RowCnt++;

	// Set row properties
	$t06_daftarsiswadetail->ResetAttrs();
	$t06_daftarsiswadetail->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t06_daftarsiswadetail_delete->LoadRowValues($t06_daftarsiswadetail_delete->Recordset);

	// Render row
	$t06_daftarsiswadetail_delete->RenderRow();
?>
	<tr<?php echo $t06_daftarsiswadetail->RowAttributes() ?>>
<?php if ($t06_daftarsiswadetail->siswa_id->Visible) { // siswa_id ?>
		<td<?php echo $t06_daftarsiswadetail->siswa_id->CellAttributes() ?>>
<span id="el<?php echo $t06_daftarsiswadetail_delete->RowCnt ?>_t06_daftarsiswadetail_siswa_id" class="t06_daftarsiswadetail_siswa_id">
...
<?php
	$t06_daftarsiswadetail_delete->Recordset->MoveNext();
}
$t06_daftarsiswadetail_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t06_daftarsiswadetail_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft06_daftarsiswadetaildelete.Init();
</script>
<?php
$t06_daftarsiswadetail_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t06_daftarsiswadetail_delete->Page_Terminate();
?>
