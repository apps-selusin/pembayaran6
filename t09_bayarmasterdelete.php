...
$t09_bayarmaster_delete = NULL; // Initialize page object first

class ct09_bayarmaster_delete extends ct09_bayarmaster {
	...
	// Page object name
	var $PageObjName = 't09_bayarmaster_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t09_bayarmasterlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t09_bayarmaster class, t09_bayarmasterinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t09_bayarmasterlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t09_bayarmaster_delete)) $t09_bayarmaster_delete = new ct09_bayarmaster_delete();

// Page init
$t09_bayarmaster_delete->Page_Init();

// Page main
$t09_bayarmaster_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t09_bayarmaster_delete->Page_Render();
?>
...
var CurrentForm = ft09_bayarmasterdelete = new ew_Form("ft09_bayarmasterdelete", "delete");

// Form_CustomValidate event
ft09_bayarmasterdelete.Form_CustomValidate = 
...
ft09_bayarmasterdelete.ValidateRequired = true;
<?php } else { ?>
ft09_bayarmasterdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft09_bayarmasterdelete.Lists["x_siswa_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_NIS","x_Nama","",""],"ParentFields":[],"ChildFields":["t10_bayardetail x_siswaspp_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t04_siswa"};
ft09_bayarmasterdelete.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_tahunajaran"};
...
<?php $t09_bayarmaster_delete->ShowPageHeader(); ?>
<?php
$t09_bayarmaster_delete->ShowMessage();
?>
<form name="ft09_bayarmasterdelete" id="ft09_bayarmasterdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t09_bayarmaster_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t09_bayarmaster_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t09_bayarmaster">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t09_bayarmaster_delete->RecKeys as $key) { ?>
...
<?php if ($t09_bayarmaster->siswa_id->Visible) { // siswa_id ?>
		<th><span id="elh_t09_bayarmaster_siswa_id" class="t09_bayarmaster_siswa_id"><?php echo $t09_bayarmaster->siswa_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t09_bayarmaster->tahunajaran_id->Visible) { // tahunajaran_id ?>
		<th><span id="elh_t09_bayarmaster_tahunajaran_id" class="t09_bayarmaster_tahunajaran_id"><?php echo $t09_bayarmaster->tahunajaran_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t09_bayarmaster->Tanggal->Visible) { // Tanggal ?>
		<th><span id="elh_t09_bayarmaster_Tanggal" class="t09_bayarmaster_Tanggal"><?php echo $t09_bayarmaster->Tanggal->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t09_bayarmaster->NomorBayar->Visible) { // NomorBayar ?>
		<th><span id="elh_t09_bayarmaster_NomorBayar" class="t09_bayarmaster_NomorBayar"><?php echo $t09_bayarmaster->NomorBayar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t09_bayarmaster->Jumlah->Visible) { // Jumlah ?>
		<th><span id="elh_t09_bayarmaster_Jumlah" class="t09_bayarmaster_Jumlah"><?php echo $t09_bayarmaster->Jumlah->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t09_bayarmaster_delete->RecCnt = 0;
$i = 0;
while (!$t09_bayarmaster_delete->Recordset->EOF) {
	$t09_bayarmaster_delete->RecCnt++;
	$t09_bayarmaster_delete->RowCnt++;

	// Set row properties
	$t09_bayarmaster->ResetAttrs();
	$t09_bayarmaster->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t09_bayarmaster_delete->LoadRowValues($t09_bayarmaster_delete->Recordset);

	// Render row
	$t09_bayarmaster_delete->RenderRow();
?>
	<tr<?php echo $t09_bayarmaster->RowAttributes() ?>>
<?php if ($t09_bayarmaster->siswa_id->Visible) { // siswa_id ?>
		<td<?php echo $t09_bayarmaster->siswa_id->CellAttributes() ?>>
<span id="el<?php echo $t09_bayarmaster_delete->RowCnt ?>_t09_bayarmaster_siswa_id" class="t09_bayarmaster_siswa_id">
...
<span id="el<?php echo $t09_bayarmaster_delete->RowCnt ?>_t09_bayarmaster_tahunajaran_id" class="t09_bayarmaster_tahunajaran_id">
...
<span id="el<?php echo $t09_bayarmaster_delete->RowCnt ?>_t09_bayarmaster_Tanggal" class="t09_bayarmaster_Tanggal">
...
<span id="el<?php echo $t09_bayarmaster_delete->RowCnt ?>_t09_bayarmaster_NomorBayar" class="t09_bayarmaster_NomorBayar">
...
<span id="el<?php echo $t09_bayarmaster_delete->RowCnt ?>_t09_bayarmaster_Jumlah" class="t09_bayarmaster_Jumlah">
...
<?php
	$t09_bayarmaster_delete->Recordset->MoveNext();
}
$t09_bayarmaster_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t09_bayarmaster_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft09_bayarmasterdelete.Init();
</script>
<?php
$t09_bayarmaster_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t09_bayarmaster_delete->Page_Terminate();
?>
