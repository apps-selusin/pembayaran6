...
$t08_siswaspp_edit = NULL; // Initialize page object first

class ct08_siswaspp_edit extends ct08_siswaspp {
	...
	// Page object name
	var $PageObjName = 't08_siswaspp_edit';
...
// Create page object
if (!isset($t08_siswaspp_edit)) $t08_siswaspp_edit = new ct08_siswaspp_edit();

// Page init
$t08_siswaspp_edit->Page_Init();

// Page main
$t08_siswaspp_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t08_siswaspp_edit->Page_Render();
?>
...
var CurrentForm = ft08_siswasppedit = new ew_Form("ft08_siswasppedit", "edit");

// Validate form
ft08_siswasppedit.Validate = function() {
...
ft08_siswasppedit.Form_CustomValidate = 
...
ft08_siswasppedit.ValidateRequired = true;
<?php } else { ?>
ft08_siswasppedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft08_siswasppedit.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_tahunajaran"};
ft08_siswasppedit.Lists["x_spp_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_SPP","x_Jenis","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t07_spp"};
...
<?php if (!$t08_siswaspp_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t08_siswaspp_edit->ShowPageHeader(); ?>
<?php
$t08_siswaspp_edit->ShowMessage();
?>
<form name="ft08_siswasppedit" id="ft08_siswasppedit" class="<?php echo $t08_siswaspp_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t08_siswaspp_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t08_siswaspp_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t08_siswaspp" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t08_siswaspp->id->CurrentValue) ?>">
<?php if (!$t08_siswaspp_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t08_siswaspp_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t08_siswaspp_edit->Pager)) $t08_siswaspp_edit->Pager = new cPrevNextPager($t08_siswaspp_edit->StartRec, $t08_siswaspp_edit->DisplayRecs, $t08_siswaspp_edit->TotalRecs) ?>
<?php if ($t08_siswaspp_edit->Pager->RecordCount > 0 && $t08_siswaspp_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t08_siswaspp_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t08_siswaspp_edit->PageUrl() ?>start=<?php echo $t08_siswaspp_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t08_siswaspp_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t08_siswaspp_edit->PageUrl() ?>start=<?php echo $t08_siswaspp_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t08_siswaspp_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t08_siswaspp_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t08_siswaspp_edit->PageUrl() ?>start=<?php echo $t08_siswaspp_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t08_siswaspp_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t08_siswaspp_edit->PageUrl() ?>start=<?php echo $t08_siswaspp_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t08_siswaspp_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
...
<script type="text/javascript">
ft08_siswasppedit.Init();
</script>
<?php
$t08_siswaspp_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t08_siswaspp_edit->Page_Terminate();
?>
